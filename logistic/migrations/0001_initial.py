...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Logistic'
        db.create_table('logistic', (
            ...
            ('position', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
            ('remark', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('logistic', ['Logistic'])

        # Adding unique constraint on 'Logistic', fields ['book', 'position']
        db.create_unique('logistic', ['book_id', 'position'])


    def backwards(self, orm):
        # Removing unique constraint on 'Logistic', fields ['book', 'position']
        db.delete_unique('logistic', ['book_id', 'position'])

        # Deleting model 'Logistic'
        db.delete_table('logistic')
    ...
    models = {
        ...
        'logistic.logistic': {
            'Meta': {'unique_together': "(('book', 'position'),)", 'object_name': 'Logistic', 'db_table': "'logistic'"},
            ...
            'position': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
