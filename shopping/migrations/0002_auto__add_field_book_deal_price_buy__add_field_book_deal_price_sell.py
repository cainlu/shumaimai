...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book_Deal.price_buy'
        db.add_column('book_deal', 'price_buy',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Book_Deal.price_sell'
        db.add_column('book_deal', 'price_sell',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book_Deal.price_buy'
        db.delete_column('book_deal', 'price_buy')

        # Deleting field 'Book_Deal.price_sell'
        db.delete_column('book_deal', 'price_sell')
